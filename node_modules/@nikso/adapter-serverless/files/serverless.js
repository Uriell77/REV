...
var require_finish = __commonJS((exports, module) => {
  "use strict";
...
var require_get_framework = __commonJS((exports, module) => {
  "use strict";
...
var require_clean_up_event = __commonJS((exports, module) => {
  "use strict";
...
var require_create_request = __commonJS((exports, module) => {
  "use strict";
  var URL = require("url");
...
var require_is_binary = __commonJS((exports, module) => {
  ...
  function isBinaryContent(headers, options) {
    const contentTypes = [].concat(options.binary ? options.binary : BINARY_CONTENT_TYPES).map((candidate) => new RegExp(`^${candidate.replace(/\*/g, ".*")}$`));
...
var require_sanitize_headers = __commonJS((exports, module) => {
  "use strict";
...
var require_format_response = __commonJS((exports, module) => {
  "use strict";
...
var require_aws = __commonJS((exports, module) => {
...
var require_get_provider = __commonJS((exports, module) => {
  var aws = require_aws();
  var providers = {
    aws
  };
...
var require_serverless_http = __commonJS((exports, module) => {
  "use strict";
...
// node_modules/matchit/lib/matchit.js
var require_matchit = __commonJS((exports) => {
  "use strict";
...
var require_trouter = __commonJS((exports, module) => {
  var {exec, match, parse} = require_matchit();
  var Trouter = class {
    constructor(opts) {
      this.opts = opts || {};
      this.routes = {};
...
var require_polka = __commonJS((exports, module) => {
  var http = require("http");
  var Router = require_trouter();
  var {parse} = require("querystring");
  var parser = require_url();
  function lead(x) {
  ...
  var Polka = class extends Router {
    constructor(opts = {}) {
      super(opts);
      this.apps = {};
      this.wares = [];
...
// node_modules/sirv/node_modules/@polka/url/build.js
...
var import_polka = __toModule(require_polka());
...
// node_modules/@sveltejs/kit/dist/chunks/index.js
...
function get_body(req) {
  ...
  const has_body = headers["content-type"] !== void 0 && (headers["transfer-encoding"] !== void 0 || !isNaN(Number(headers["content-length"])));
  if (!has_body)
...
var mutable = (dir) => (0, import_sirv.default)(dir, {
  etag: true,
  maxAge: 0
});
var noop_handler = (_req, _res, next) => next();
var prerendered_handler = fs.existsSync("prerendered") ? mutable("prerendered") : noop_handler;
var assets_handler = (0, import_sirv.default)(path.join(__dirname, "/assets"), {
  maxAge: 31536e3,
  immutable: true
});
var server = (0, import_polka.default)().use((0, import_compression.default)({threshold: 0}), assets_handler, prerendered_handler, async (req, res) => {
  const params = {
    method: req.method,
    headers: req.headers,
    path: req.path || "/",
...
var handler = (0, import_serverless_http.default)(server);
export {
  handler
};
